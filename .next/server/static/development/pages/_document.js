...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FSDocument; });
...
var _jsxFileName = "/Users/mlyck/web/fs-next/pages/_document.js";
...
/*#__PURE__*/
function (_Document) {
  _inherits(FSDocument, _Document);

  _createClass(FSDocument, null, [{
    key: "getInitialProps",
    value: function () {
  ...
  function FSDocument(props) {
    var _this;

    _classCallCheck(this, FSDocument);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(FSDocument).call(this, props));
