        ...
        <FooterContainer>
          <FooterDisclaimer>
            ...
            <Disclaimer>
              ...
              equity employed to sustain securities trading of +78.94% in 2009, +44.64% in 2010 and +17.51% in 2011.
              This properly reflects all factors of market liquidity, trading costs and slippage, financial risk, human
              ...
              Backtested performance results have certain inherent limitations, as they could potentially be designed
              with some benefit of hindsight, even though every effort have been made to avoid such risk. Unlike an
              actual performance record such as the one mentioned above, backtested results do not represent actual
              trading and may not be impacted by brokerage and other slippage fees. Also, since transactions may or may
              not have been executed, results may have under- or over-compensated for impact, if any, of certain market
              factors, such as lack of market liquidity or level of participation.
              <br />
              <br />
              Past results of any investment system are not necessarily indicative of future results. No representation
              is being made that you are likely to achieve profits or losses similar to those shown here. In addition,
              ...
              exclusive responsibility to review and evaluate the content and to determine whether to accept or reject
              any content. Formula Stocks expresses no opinion as to whether any of the website content is appropriate
              for a user’s investment portfolio, strategy, financial situation, or investment objective(s).
              <br />
              <br />
            </Disclaimer>
            <Disclaimer>
